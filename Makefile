...
db-dev:
	sudo docker compose -f docker-compose-development.yml exec db psql -U anish -d codearena

db-prod:
	sudo docker compose -f docker-compose.yml exec db psql -U anish -d codearena
