...
const generateEmailContent = (otp: string, username: string, type: string) => {
  ...
  const subjectText = isRegister
    ? "Thank you for signing up for CodeArena! To verify your email address, please enter the One-Time Password (OTP) below:"
    : "To log in to CodeArena, please enter the One-Time Password (OTP) below:";
  ...
  return `
      <body style="margin: 0; padding: 0; width: 100%; font-family: Arial, sans-serif;">
          <div style="max-width: 600px; width: 100%; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px; background-color: #f9fafb; box-sizing: border-box;">
              ...
              <p style="color: #555; font-size: 16px; line-height: 1.6; text-align: center;">Best regards,<br>CodeArena Team</p>
              ...
              <p style="font-size: 13px; color: #a1a1a1; text-align: center; line-height: 1.5;">
                  ...
                  <a href="mailto:codearena.noreply@gmail.com" style="color: #ad44d9; text-decoration: none;">codearena.noreply@gmail.com</a>.
              </p>
          </div>
      </body>
      `;
